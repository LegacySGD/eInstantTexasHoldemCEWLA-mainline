...
public class TexasHoldemCEWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(TexasHoldemCEWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/TexasHoldemWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/TexasHoldemWLAIW/InitOutcome.xml").getDocumentElement();
